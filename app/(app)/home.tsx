  ...
  useEffect(() => {
    if (profile) {
      ...
      history.forEach((req) => {
        ...
        // Correctly handle leave types by name (since leave_type is now UUID)
      ...
      setLeaveBalances([
        { type: "Annual", days: estimatedAlloc, used: annualUsed, color: "#3B82F6" },
        { type: "Sick", days: 10 + sickUsed, used: sickUsed, color: "#10B981" }, // Mock allocation
        { type: "Special", days: 5 + specialUsed, used: specialUsed, color: "#8B5CF6" }, // Mock allocation
      ]);
